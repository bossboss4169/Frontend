...
<div class="container my-5">
    ...
    <Image src="/s.png" className="bd-placeholder-img rounded-circle" alt="image" width={180} height={180}/>
      <div class="col-sm-8 py-5 mx-auto">
        <h1 class="display-5 fw-normal">Contact</h1>
        <p class="fs-5">FB: ศิรวิทย์ รินคำ</p>
        <p class="fs-5">Line: Knight-non</p>
        <p class="fs-5">contact: 099-896-2621</p>
    </div>
    </div>
  </div>
    </main>
